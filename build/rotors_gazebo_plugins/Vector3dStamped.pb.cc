...
class Vector3dStampedDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Vector3dStamped>
      _instance;
} _Vector3dStamped_default_instance_;
}  // namespace gz_geometry_msgs
namespace protobuf_Vector3dStamped_2eproto {
static void InitDefaultsVector3dStamped() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::gz_geometry_msgs::_Vector3dStamped_default_instance_;
    new (ptr) ::gz_geometry_msgs::Vector3dStamped();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::gz_geometry_msgs::Vector3dStamped::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<2> scc_info_Vector3dStamped =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsVector3dStamped}, {
      &protobuf_Header_2eproto::scc_info_Header.base,
      &protobuf_vector3d_2eproto::scc_info_Vector3d.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Vector3dStamped.base);
}

::google::protobuf::Metadata file_level_metadata[1];

const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gz_geometry_msgs::Vector3dStamped, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gz_geometry_msgs::Vector3dStamped, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gz_geometry_msgs::Vector3dStamped, header_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::gz_geometry_msgs::Vector3dStamped, position_),
  0,
  1,
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, sizeof(::gz_geometry_msgs::Vector3dStamped)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::gz_geometry_msgs::_Vector3dStamped_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "Vector3dStamped.proto", schemas, file_default_instances, TableStruct::offsets,
...
void Vector3dStamped::InitAsDefaultInstance() {
  ::gz_geometry_msgs::_Vector3dStamped_default_instance_._instance.get_mutable()->header_ = const_cast< ::gz_std_msgs::Header*>(
      ::gz_std_msgs::Header::internal_default_instance());
  ::gz_geometry_msgs::_Vector3dStamped_default_instance_._instance.get_mutable()->position_ = const_cast< ::gazebo::msgs::Vector3d*>(
...
Vector3dStamped::Vector3dStamped()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_Vector3dStamped_2eproto::scc_info_Vector3dStamped.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* Vector3dStamped::descriptor() {
  ::protobuf_Vector3dStamped_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_Vector3dStamped_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const Vector3dStamped& Vector3dStamped::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_Vector3dStamped_2eproto::scc_info_Vector3dStamped.base);
...
size_t Vector3dStamped::RequiredFieldsByteSizeFallback() const {
...
size_t Vector3dStamped::ByteSizeLong() const {
...
::google::protobuf::Metadata Vector3dStamped::GetMetadata() const {
  protobuf_Vector3dStamped_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_Vector3dStamped_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::gz_geometry_msgs::Vector3dStamped* Arena::CreateMaybeMessage< ::gz_geometry_msgs::Vector3dStamped >(Arena* arena) {
  return Arena::CreateInternal< ::gz_geometry_msgs::Vector3dStamped >(arena);
}
}  // namespace protobuf
}  // namespace google
