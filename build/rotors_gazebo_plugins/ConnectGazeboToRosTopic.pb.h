...
#ifndef PROTOBUF_INCLUDED_ConnectGazeboToRosTopic_2eproto
#define PROTOBUF_INCLUDED_ConnectGazeboToRosTopic_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ConnectGazeboToRosTopic_2eproto 
...
extern ConnectGazeboToRosTopicDefaultTypeInternal _ConnectGazeboToRosTopic_default_instance_;
}  // namespace gz_std_msgs
namespace google {
namespace protobuf {
template<> ::gz_std_msgs::ConnectGazeboToRosTopic* Arena::CreateMaybeMessage<::gz_std_msgs::ConnectGazeboToRosTopic>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace gz_std_msgs {
...
class ConnectGazeboToRosTopic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gz_std_msgs.ConnectGazeboToRosTopic) */ {
 public:
  ...
  #if LANG_CXX11
  ConnectGazeboToRosTopic(ConnectGazeboToRosTopic&& from) noexcept
    : ConnectGazeboToRosTopic() {
    *this = ::std::move(from);
  }

  inline ConnectGazeboToRosTopic& operator=(ConnectGazeboToRosTopic&& from) noexcept {
  ...
  static inline const ConnectGazeboToRosTopic* internal_default_instance() {
    return reinterpret_cast<const ConnectGazeboToRosTopic*>(
  ...
  friend void swap(ConnectGazeboToRosTopic& a, ConnectGazeboToRosTopic& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ConnectGazeboToRosTopic* New() const final {
    return CreateMaybeMessage<ConnectGazeboToRosTopic>(NULL);
  }

  ConnectGazeboToRosTopic* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ConnectGazeboToRosTopic>(arena);
  }
 ...
 private:
  ...
  int msgtype_;
  friend struct ::protobuf_ConnectGazeboToRosTopic_2eproto::TableStruct;
};
// ===================================================================
...
#if LANG_CXX11
inline void ConnectGazeboToRosTopic::set_gazebo_topic(::std::string&& value) {
  set_has_gazebo_topic();
  gazebo_topic_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:gz_std_msgs.ConnectGazeboToRosTopic.gazebo_topic)
}
#endif
...
#if LANG_CXX11
inline void ConnectGazeboToRosTopic::set_ros_topic(::std::string&& value) {
  set_has_ros_topic();
  ros_topic_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:gz_std_msgs.ConnectGazeboToRosTopic.ros_topic)
}
#endif
...
template <> struct is_proto_enum< ::gz_std_msgs::ConnectGazeboToRosTopic_MsgType> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_ConnectGazeboToRosTopic_2eproto
